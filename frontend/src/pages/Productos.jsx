...
const Productos = () => {
  ...
  // Configurar react-to-print ANTES de usarlo
  ...
  // Efecto para manejar la impresión cuando hay un producto seleccionado
  useEffect(() => {
  ...
  const iniciarImpresionQR = (producto) => {
  ...
  return (
    <div className="p-6">
      ...
      {/* Área oculta para la impresión - RENDERIZADO CONDICIONAL */}
